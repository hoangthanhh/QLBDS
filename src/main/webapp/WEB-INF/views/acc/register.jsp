        ...
        <div class="col-md-6">
            ...
            <div class="card card-auth p-4">
                ...
                <c:if test="${not empty error}">
                    <div class="alert alert-danger py-2 small text-center fw-semibold">
                ...
                <form action="${pageContext.request.contextPath}/acc/register" method="POST">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="fullName" class="form-control" value="${userDto.fullName}" placeholder="Nguyễn Văn A" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label small fw-semibold">Số điện thoại</label>
                            <input type="tel" name="phone" class="form-control" value="${userDto.phone}" placeholder="0987654321" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label small fw-semibold">Địa chỉ Email</label>
                        <input type="email" name="email" class="form-control" value="${userDto.email}" placeholder="name@example.com" required>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label small fw-semibold">Mật khẩu</label>
                            <input type="password" name="password" class="form-control" value="${userDto.password}" placeholder="Tối thiểu 6 ký tự" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label small fw-semibold">Xác nhận mật khẩu</label>
                            <input type="password" name="confirmPassword" class="form-control" value="${userDto.confirmPassword}" placeholder="••••••••" required>
                        </div>
                    </div>



                    <button type="submit" class="btn btn-makaan w-100 py-2 fw-bold">Đăng Ký</button>
                </form>
