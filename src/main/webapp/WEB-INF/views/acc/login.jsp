            ...
            <div class="card card-auth p-4">
                ...
                <div class="text-center mt-4">
                    <p class="small text-muted mb-0">Chưa có tài khoản?
                        <a href="${pageContext.request.contextPath}/acc/register" class="text-makaan fw-semibold text-decoration-none">Đăng ký ngay</a>
                    </p>
                    <hr class="text-muted">
                    <a href="${pageContext.request.contextPath}/home" class="small text-secondary text-decoration-none"><i class="fa fa-arrow-left me-1"></i> Quay lại trang chủ</a>
                </div>
            </div>
        </div>
    </div>
